...
about 0.92, against about 0.93 for the model, so the marginals account for
nearly all of it. The correlation defects are real but they are not the binding constraint.
